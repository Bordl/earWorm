...
/**
 * We'll load the MomentJS library which is the javascript equivalent to Carbon.
 ...
 * Use IDB Promises to cache files in the IndexedDB storage for offline
 * purposes. Ensure that use import Promise and Fecth polyfills
 */

// window.idb = require('idb');
// require('./utilities/promise');
